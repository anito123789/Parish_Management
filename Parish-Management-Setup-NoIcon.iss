...
[Files]
Source: "*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "installer\*,*.iss,INSTALL.bat,Build-Installer.bat,Create-Icon.bat"

[Icons]
Name: "{group}\Parish Management System"; Filename: "{app}\Launch Parish M.vbs"; WorkingDir: "{app}"
Name: "{group}\{cm:UninstallProgram,Parish Management System}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\Parish Management System"; Filename: "{app}\Launch Parish M.vbs"; WorkingDir: "{app}"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Parish Management System"; Filename: "{app}\Launch Parish M.vbs"; WorkingDir: "{app}"; Tasks: quicklaunchicon
